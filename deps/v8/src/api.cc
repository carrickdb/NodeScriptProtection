...
#include "src/api.h"
#include <openssl/evp.h>  // For hashing in Compile
...
ScriptCompiler::StreamedSource::GetCachedData() const {
  printf("ScriptCompiler::CachedData 1974\n");
...
MaybeLocal<UnboundScript> ScriptCompiler::CompileUnboundInternal(
  ...
  printf("ScriptCompiler::CompileUnboundInternal 2207");
...
MaybeLocal<UnboundScript> ScriptCompiler::CompileUnboundScript(
    Isolate* v8_isolate, Source* source, CompileOptions options) {
  printf("ScriptCompiler::CompileUnboundScript 2282");
  Utils::ApiCheck(
...
Local<UnboundScript> ScriptCompiler::CompileUnbound(Isolate* v8_isolate,
  ...
  printf("ScriptCompiler::CompileUnbound 2296");
  Utils::ApiCheck(
      !source->GetResourceOptions().IsModule(),
...
MaybeLocal<Script> ScriptCompiler::Compile(Local<Context> context,
  ...
  Utils::ApiCheck(
      ...
      "v8::ScriptCompiler::CompileModule must be used to compile modules");
  // EVP_sha256()
//  printf("hello from 2303 compile\n");
...
MaybeLocal<Module> ScriptCompiler::CompileModule(Isolate* isolate,
                                                 Source* source) {
  printf("Hello from CompileModule 2331\n");
  i::Isolate* i_isolate = reinterpret_cast<i::Isolate*>(isolate);
...
MaybeLocal<Function> ScriptCompiler::CompileFunctionInContext(
  ...
  printf("ScriptCompiler::CompileFunctionInContext 2396");
...
MaybeLocal<Script> ScriptCompiler::Compile(Local<Context> context,
  ...
  printf("ScriptCompiler::Compile 2524");
  TRACE_EVENT0("v8", "V8.ScriptCompiler");
...
MaybeLocal<Script> Script::Compile(Local<Context> context, Local<String> source,
                                   ScriptOrigin* origin) {
  printf("hello from 2592 Compile\n");
  printf("%s", *String::Utf8Value(origin->ResourceName()));
  if (origin) {
...
Local<Script> Script::Compile(v8::Local<String> source,
  ...
  printf("In 2614 Compile. File name: %s", *String::Utf8Value(file_name));
  auto str = Utils::OpenHandle(*source);
  auto context = ContextFromHeapObject(str);
